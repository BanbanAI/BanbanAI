<div align="center">
  <a href="https://www.banban.work/">
    <img src="https://www.banban.work/image/header/logo.svg" alt="Banban AI" width="280" />
  </a>
...
<table>
  <tr>
    <td width="50%"><strong>AI 辅助构建</strong><br />用自然语言生成应用、表单、公式和流程，降低业务系统搭建门槛。</td>
    <td width="50%"><strong>数据自主可控</strong><br />支持私有化、内网与离线部署，业务数据保存在自己的环境中。</td>
  </tr>
  <tr>
...
- **应用生成**：根据业务场景描述，生成表单字段、页面布局、计算公式和流程逻辑。
